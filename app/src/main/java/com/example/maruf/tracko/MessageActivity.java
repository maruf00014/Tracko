...
import com.example.maruf.tracko.Adapter.MessageAdapter;
import com.example.maruf.tracko.Fragments.APIService;
import com.example.maruf.tracko.Model.Chat;
import com.example.maruf.tracko.Model.User;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // and this
                startActivity(new Intent(MessageActivity.this, MessageMainActivity.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP));
            }
        });
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (user.getImageURL().equals("default")){
                    profile_image.setImageResource(R.drawable.profile_sample_image);
                } else {
                    //and this
