...
import com.example.maruf.tracko.Fragments.ChatsFragment;
import com.example.maruf.tracko.Fragments.UsersFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                viewPagerAdapter.addFragment(new UsersFragment(), "Devices");
